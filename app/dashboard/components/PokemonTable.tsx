...
function descendingComparator<T>(a: T, b: T, orderBy: keyof T) {
  ...
  interface EnhancedTableProps {
    numSelected: number;
    onRequestSort: (event: React.MouseEvent<unknown>, property: keyof PokemonData) => void;
...
const PokemonTable = ({PokemonData}: {PokemonData: PokemonData[]}) => {
    ...
    const [orderBy, setOrderBy] = React.useState<keyof PokemonData>('number');
    ...
    const handleSelectAllClick = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const newSelected = PokemonData.map((n) => n.number);
    ...
    const visibleRows = React.useMemo(
        () =>
        stableSort(PokemonData, getComparator(order, orderBy)).slice(
            page * rowsPerPage,
